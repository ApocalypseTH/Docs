    ...
    \subsection{Fornitura}
        \subsubsection{Introduzione processo}
            ...
            \paragraph{Obbiettivi}
                L’obiettivo è quello di formalizzare le norme e le procedure che dovranno poi essere applicate dal gruppo EverBuilds. Per fare ciò il gruppo ha il compito di valutare le richieste del capitolato e prendere in considerazione le risorse necessarie ai fini del progetto, stilando il documento \dext{Studio di Fattibilità} v1.0.0. Si passa dunque a determinare le procedure e le risorse necessarie sviluppando il \dext{Piano di Progetto} v1.0.0 che segnerà le basi da seguire fino alla consegna del prodotto finito.\\
        ...
        \subsubsection{Analisi dei Requisiti}
            ...
            \paragraph{Classificazione dei requisiti}
                ...
                \begin{itemize}
                    ...
                    \item\textbf{Fonti}: indica il luogo da dove deriva il requisito, individuato tra: Capitolato d’Appalto, \dext{Verbali} Interni, \dext{Verbali} Esterni e Casi d’uso.
                \end{itemize}
