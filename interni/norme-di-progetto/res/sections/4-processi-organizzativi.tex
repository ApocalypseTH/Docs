\section{Processi organizzativi}
	\subsection{Processo di coordinamento}
		...
		\subsubsection{Strumenti}
			\begin{itemize}
				\item \href{Discord}{https://discordapp.com/company/ }
				\item \href{Gmail}{https://www.google.com/intl/it/gmail/about/ }
				\item \href{Google Meet}{https://meet.google.com/?hs=197\&pli=1\&authuser=0 }
			\end{itemize}
	\subsection{Processo di pianificazione}
		...
		\subsubsection{Ciclo di vita dei ticket}
			...
			\begin{itemize}
				...
				\item\textbf{pull request} % da fare
