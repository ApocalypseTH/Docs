\section{Qualità di prodotto}
	...
	Il prodotto finale deve essere il più possibile avvicinarsi a quello desiderato, in quanto a efficienza, aspettative, utilizzo, vincoli adempiti se il prodotto finale è conforme a quanto descritto nell'\dext{Analisi dei requisiti v1.0.0}: per questo motivo si procederà a definire delle metriche che si baseranno su quanto descritto in tale documento.
	
		\paragraph{Obiettivi}
			\begin{itemize}
				\item\textbf{Completezza dell'implementazione}: il prodotto finale deve adempiere a tutti i vincoli e fornire tutte le caratteristiche prefissati, ed esposti dentro al \dext{Analisi dei Requisiti v1.0.0}
		...
		\paragraph{Metriche}
			...
			\begin{itemize}
     				...
     				\item  QM-PD-SVL02  Requisiti completati totali da \dext{Piano di Progetto v1.0.0} fino a un determinato momento (RTOT)
			\end{itemize}
		\paragraph{Indici di qualità}
			\begin{center}
